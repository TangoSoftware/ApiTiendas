...
| **IvaIncluded**            DEPRECADO<br/>(Delta 4)| No                             | Indica que los importes informados incluyen IVA                                                                     | De tipo lógico                                                                                         | True/False <br/> **Importante:** A partir de la versión Delta 4, este campo ha sido deprecado. Si se informa un valor, será ignorado. Si se envia PriceListNumber, el desglose impositivo se definirá en base a la configuración de la lista de precios en Tango.                                                                                                                                                         |
| **InternalTaxIncluded**    DEPRECADO<br/>(Delta 4)| No                        | Indica que los importes informados incluyen impuestos internos                                                      | De tipo lógico                                                                                         | True/False <br/> **Importante:** A partir de la versión Delta 4, este campo ha sido deprecado. Si se informa un valor, será ignorado.Si se envia PriceListNumber, el desglose impositivo se definirá en base a la configuración de la lista de precios en Tango.                                                                                                                                                    |
