...
| Obtener los saldos de stock acumulados por artículo indicando que depósitos y sucursales se desea consultar indicando dichos valores separados por coma (,). En el ejemplo se muestra el caso donde existe un código de depósito que posee un espacio en blanco " 1" represenado como "_1".  | https://tiendas.axoft.com/api/Aperture/Stock?pageSize=500&pageNumber=1&groupByProduct=true&WarehouseCode=01,_1,02&StoreNumber=5,6                     |
